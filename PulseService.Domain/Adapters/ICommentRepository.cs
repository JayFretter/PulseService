...
namespace PulseService.Domain.Adapters
{
    public interface ICommentRepository
    {
        ...
        Task IncrementCommentDownvotesAsync(string commentId, int increment, CancellationToken cancellationToken);
        Task AdjustCommentVotesAsync(string commentId, int upvoteIncrement, int downvoteIncrement, CancellationToken cancellationToken);
    }
}
